...
<body>
    <form action="sign-up-handler.php" method="post" novalidate>
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value=<?php htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>>
        </div>
        <div>
        ...
        <p class="login-signup-link">already have an account? <a href="login.php">login</a></p>
    </form>
